...
import com.maxwell.tamilcric.adapter.TournamentsForPointsTableAdapter;
...
public class PointsTableNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pints_table_new);
    ...
    public void tournamentListing(){
        RequestQueue queue = Volley.newRequestQueue(PointsTableNewActivity.this);
                            ...
                            if(response.has("status")){
                                ...
                                if(responsecode.matches("200")&&message.matches("Success")){
                                    ...
                                    if(response.has("tournament_service")){
                                        ...
                                        mAdapter=new TournamentsForPointsTableAdapter(getApplicationContext(),tournamentsModelList);

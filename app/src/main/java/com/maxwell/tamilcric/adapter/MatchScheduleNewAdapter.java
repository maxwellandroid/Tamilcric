...
public class MatchScheduleNewAdapter extends RecyclerView.Adapter<MatchScheduleNewAdapter.ViewHolder>{

    List<TournamentsModel> peoplesModels;
    Context context;

    public MatchScheduleNewAdapter(Context mcontext, List<TournamentsModel> peoplesModelList){
...
// parse the String "29/07/2013" to a java.util.Date object
       ...
       viewHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               Intent i=new Intent(context, MatchScheduleActivity.class);

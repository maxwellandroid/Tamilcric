...
public class ResultsAdapter extends PagerAdapter {
    private LayoutInflater layoutInflater;
    Activity activity;
    List<ResultMatchesModels> liveMatchModelList;

    public ResultsAdapter(Activity activity, List<ResultMatchesModels> liveMatchModelList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        TextView tv_winning_description = (TextView) view.findViewById(R.id.text_winning_description);
        ...
        TextView teamBOvers = (TextView) view.findViewById(R.id.text_teamB_overs);
            ...
            tv_winning_description.setText(liveMatchModelList.get(position).getStadium());
